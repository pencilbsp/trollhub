...
export default function MetaIcon({ className, ...props }: SVGProps<SVGSVGElement>) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 48 48" {...props}>
            ...
            />
            <linearGradient id="wSMw7pqi7WIWHewz2_TZXa" x1="42.304" x2="13.533" y1="24.75" y2="24.75" gradientUnits="userSpaceOnUse">
            ...
            />
            <linearGradient id="wSMw7pqi7WIWHewz2_TZXb" x1="7.635" x2="7.635" y1="32.87" y2="13.012" gradientUnits="userSpaceOnUse">
                <stop offset="0" stopColor="#0081fb" />
                <stop offset=".995" stopColor="#0064e1" />
            </linearGradient>
            <path
