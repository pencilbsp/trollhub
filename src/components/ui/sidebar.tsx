        ...
        return (
            <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
                <SheetContent
                    ...
                    data-mobile="true"
                    className="max-w-[--sidebar-width] bg-sidebar p-0 text-sidebar-foreground sm:max-w-[--sidebar-width] [&>button]:hidden"
                    style={
                        {
...
const SidebarInset = React.forwardRef<HTMLDivElement, React.ComponentProps<'main'>>(({ className, ...props }, ref) => {
    return (
        <main
            ref={ref}
            className={cn(
                'relative flex max-h-svh max-w-full flex-1 flex-col bg-background',
