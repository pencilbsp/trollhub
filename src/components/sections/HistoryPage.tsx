    ...
    <div className="container p-2 sm:px-8 xl:max-w-7xl">
      <div className="grid grid-cols-3 gap-6 w-full p-2">
        <div className="flex flex-col gap-4 col-span-3 lg:col-span-2">
          <h1 className="font-bold text-2xl uppercase text-blue-500">
            Nhật ký xem ({total})
          </h1>
            ...
            {histories.map(({ content, id, chapter, updatedAt }) => (
              <div key={id} className="flex">
                ...
                <div className="flex flex-col ml-3 w-full">
                  ...
                  <Link
                    href={`/${content.type}/${slug(content.title)}-${
                      content.id
                    }`}
                  >
                    <h3 className="font-semibold lg:text-lg line-clamp-1 lg:line-clamp-2">
                      {content.title}
                    </h3>
                  </Link>
