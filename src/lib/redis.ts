...
const redisClient = global.redis || createClient({ url: REDIS_URL });
...
redisClient.on('ready', () => console.log('Redis Client Ready')).on('error', (err) => console.log('Redis Client Error:', err));
